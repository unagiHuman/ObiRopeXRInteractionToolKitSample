...
public class ClimbBaseProvider : LocomotionProvider
{
    ...
    readonly List<IClimbGrabbable> m_GrabbedClimbables = new List<IClimbGrabbable>();
    ...
    /// </remarks>
    public void StartClimbGrab(IClimbGrabbable climbInteractable, IXRSelectInteractor interactor)
    {
        ...
        GrabCount = m_GrabbingInteractors.Count;
    ...
    void UpdateClimbAnchor(IClimbGrabbable climbInteractable, IXRInteractor interactor)
    {
    ...
    protected virtual void Update()
    {
        ...
        void StepClimbMovement(IClimbGrabbable currentClimbInteractable, IXRSelectInteractor currentInteractor)
        {
            var xrOrigin = system.xrOrigin?.Origin;
            if (xrOrigin != null)
            {
        ...
        ClimbSettings GetActiveClimbSettings(IClimbGrabbable climbInteractable)
        {
